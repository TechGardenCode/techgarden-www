...
@Directive({
	selector: '[seedPaginationContent]',
	host: {
		'[class]': '_computedClass()',
	},
})
export class SeedPaginationContent {
	public readonly userClass = input<ClassValue>('', { alias: 'class' });
	protected readonly _computedClass = computed(() => seed(paginationContentVariants(), this.userClass()));
}

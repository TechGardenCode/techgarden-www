...
// 	useExisting: forwardRef(() => SeedCheckbox),
// 	multi: true,
// };

// @Component({
// 	selector: 'seed-checkbox',
// 	imports: [SeedCheckbox, NgIcon, SeedIcon],
// 	template: `
// 		<seed-checkbox
// 			[id]="id()"
// 			[name]="name()"
...
// 					<ng-icon seed size="14px" name="lucideCheck" />
// 				</span>
// 			}
// 		</seed-checkbox>
// 	`,
...
// })
// export class SeedCheckbox implements ControlValueAccessor {
...
// 	/** Used to set the id on the underlying seed element. */
// 	public readonly id = input<string | null>(null);

// 	/** Used to set the aria-label attribute on the underlying seed element. */
// 	public readonly ariaLabel = input<string | null>(null, { alias: 'aria-label' });

// 	/** Used to set the aria-labelledby attribute on the underlying seed element. */
// 	public readonly ariaLabelledby = input<string | null>(null, { alias: 'aria-labelledby' });

// 	/** Used to set the aria-describedby attribute on the underlying seed element. */
